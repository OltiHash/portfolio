...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A clean school website built as an academic project using vanilla HTML, CSS, and JavaScript — no frameworks, pure fundamentals.',
    longDescription:
    ...
    features: [
      ...
      'Custom CSS layouts with Flexbox and Grid',
      'Vanilla JS interactivity — no dependencies',
      'Responsive across mobile and desktop',
      'Academic project demonstrating web fundamentals',
    ],
  },
];
